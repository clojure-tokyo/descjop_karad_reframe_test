...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__26103__auto__,writer__26104__auto__,opt__26105__auto__){
return cljs.core._write.call(null,writer__26104__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__33119 = o;
(G__33119[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__25480__auto__ = !((jsprops == null));
if(and__25480__auto__){
var and__25480__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__33128 = jsprops;
(G__33128["defaultValue"] = value);

(G__33128["onChange"] = ((function (G__33128,v,value,on_change){
return (function (p1__33125_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__33125_SHARP_);
});})(G__33128,v,value,on_change))
);

(G__33128["ref"] = ((function (G__33128,v,value,on_change){
return (function (p1__33126_SHARP_){
return (this$["cljsInputElement"] = p1__33126_SHARP_);
});})(G__33128,v,value,on_change))
);
...
var vec__33135 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__33135,(0),null);
var id = cljs.core.nth.call(null,vec__33135,(1),null);
var class$ = cljs.core.nth.call(null,vec__33135,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___33140 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___33140 == null)){
} else {
var key_33141 = temp__4661__auto___33140;
(jsprops["key"] = key_33141);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__33143 = (new reagent.impl.template.NativeWrapper());
(G__33143["name"] = c);
...
var len__26601__auto___33148 = arguments.length;
var i__26602__auto___33149 = (0);
while(true){
if((i__26602__auto___33149 < len__26601__auto___33148)){
args__26608__auto__.push((arguments[i__26602__auto___33149]));

var G__33150 = (i__26602__auto___33149 + (1));
i__26602__auto___33149 = G__33150;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__26609__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq33146){
var G__33147 = cljs.core.first.call(null,seq33146);
var seq33146__$1 = cljs.core.next.call(null,seq33146);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__33147,seq33146__$1);
});
...
break;
default:
var G__33154 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__33154;
continue;
...
var n__26415__auto___33157 = a.length;
var i_33158 = (0);
while(true){
if((i_33158 < n__26415__auto___33157)){
(a[i_33158] = reagent.impl.template.as_element.call(null,(a[i_33158])));

var G__33159 = (i_33158 + (1));
i_33158 = G__33159;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__26415__auto___33160 = a.length;
var i_33161 = (0);
while(true){
if((i_33161 < n__26415__auto___33160)){
var val_33162 = (a[i_33161]);
if((cljs.core.vector_QMARK_.call(null,val_33162)) && ((reagent.impl.template.key_from_vec.call(null,val_33162) == null))){
(o["no-key"] = true);
} else {
}

(a[i_33161] = reagent.impl.template.as_element.call(null,val_33162));
...
var ctx = ({});
var vec__33167 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__33167,(0),null);
var derefed = cljs.core.nth.call(null,vec__33167,(1),null);
...
var G__33171 = (cljs.core.count.call(null,argv) - first_child);
switch (G__33171) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__33171){
