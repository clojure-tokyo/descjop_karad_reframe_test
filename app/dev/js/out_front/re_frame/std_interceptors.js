...
var vec__27600_27603 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_27604 = cljs.core.nth.call(null,vec__27600_27603,(0),null);
var only_after_27605 = cljs.core.nth.call(null,vec__27600_27603,(1),null);
var db_changed_QMARK__27606 = (!((only_before_27604 == null))) || (!((only_after_27605 == null)));
if(db_changed_QMARK__27606){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_27604);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_27605);
...
var map__27613 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__27613__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__27613__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__27621 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__27621__$1 = ((((!((map__27621 == null)))?((((map__27621.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__27621.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__27621):map__27621);
var coeffects = map__27621__$1;
var event = cljs.core.get.call(null,map__27621__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__26898__auto___27624 = arguments.length;
var i__26899__auto___27625 = (0);
while(true){
if((i__26899__auto___27625 < len__26898__auto___27624)){
args__26905__auto__.push((arguments[i__26899__auto___27625]));

var G__27626 = (i__26899__auto___27625 + (1));
i__26899__auto___27625 = G__27626;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__26906__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq27623){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq27623));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__25789__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__26905__auto__ = [];
var len__26898__auto___27632 = arguments.length;
var i__26899__auto___27633 = (0);
while(true){
if((i__26899__auto___27633 < len__26898__auto___27632)){
args__26905__auto__.push((arguments[i__26899__auto___27633]));

var G__27634 = (i__26899__auto___27633 + (1));
i__26899__auto___27633 = G__27634;
continue;
} else {
}
break;
...
var argseq__26906__auto__ = ((((2) < args__26905__auto__.length))?(new cljs.core.IndexedSeq(args__26905__auto__.slice((2)),(0),null)):null);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__26906__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__27627_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__27628_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__27628_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq27629){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__27630,G__27631,seq27629__$2);
});
