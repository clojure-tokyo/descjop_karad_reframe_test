...
var args27309 = [];
var len__26898__auto___27312 = arguments.length;
var i__26899__auto___27313 = (0);
while(true){
if((i__26899__auto___27313 < len__26898__auto___27312)){
args27309.push((arguments[i__26899__auto___27313]));

var G__27314 = (i__26899__auto___27313 + (1));
i__26899__auto___27313 = G__27314;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args27309.length)].join('')));
...
if(cljs.core.truth_((function (){var and__25777__auto__ = required_QMARK_;
if(cljs.core.truth_(and__25777__auto__)){
return (handler == null);
} else {
return and__25777__auto__;
}
})())){
...
var args27316 = [];
var len__26898__auto___27319 = arguments.length;
var i__26899__auto___27320 = (0);
while(true){
if((i__26899__auto___27320 < len__26898__auto___27319)){
args27316.push((arguments[i__26899__auto___27320]));

var G__27321 = (i__26899__auto___27320 + (1));
i__26899__auto___27320 = G__27321;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args27316.length)].join('')));
