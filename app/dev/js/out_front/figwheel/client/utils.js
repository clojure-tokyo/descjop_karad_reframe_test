...
return (new CustomEvent(event_name,(function (){var obj32321 = {"detail":data};
return obj32321;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__25480__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__25480__auto__)){
var and__25480__auto____$1 = (window["CustomEvent"]);
...
var args32326 = [];
var len__26601__auto___32332 = arguments.length;
var i__26602__auto___32333 = (0);
while(true){
if((i__26602__auto___32333 < len__26601__auto___32332)){
args32326.push((arguments[i__26602__auto___32333]));

var G__32334 = (i__26602__auto___32333 + (1));
i__26602__auto___32333 = G__32334;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args32326.length)].join('')));
...
var f = (function (){var pred__32329 = cljs.core._EQ_;
var expr__32330 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__32329.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__32330))){
return ((function (pred__32329,expr__32330){
return (function (p1__32322_SHARP_){
return console.warn(p1__32322_SHARP_);
});
;})(pred__32329,expr__32330))
} else {
if(cljs.core.truth_(pred__32329.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__32330))){
return ((function (pred__32329,expr__32330){
return (function (p1__32323_SHARP_){
return console.debug(p1__32323_SHARP_);
});
;})(pred__32329,expr__32330))
} else {
if(cljs.core.truth_(pred__32329.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__32330))){
return ((function (pred__32329,expr__32330){
return (function (p1__32324_SHARP_){
return console.error(p1__32324_SHARP_);
});
;})(pred__32329,expr__32330))
} else {
return ((function (pred__32329,expr__32330){
return (function (p1__32325_SHARP_){
return console.log(p1__32325_SHARP_);
});
;})(pred__32329,expr__32330))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__32336){
var map__32339 = p__32336;
...
var opts = map__32339__$1;
var eval_fn = cljs.core.get.call(null,map__32339__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__32341_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__32343,(0),null);
var v = cljs.core.nth.call(null,vec__32343,(1),null);
...
var args32346 = [];
var len__26601__auto___32349 = arguments.length;
var i__26602__auto___32350 = (0);
while(true){
if((i__26602__auto___32350 < len__26601__auto___32349)){
args32346.push((arguments[i__26602__auto___32350]));

var G__32351 = (i__26602__auto___32350 + (1));
i__26602__auto___32350 = G__32351;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args32346.length)].join('')));
...
if(cljs.core.truth_((function (){var and__25480__auto__ = typeof localStorage !== 'undefined';
