...
return cljs.core._write.call(null,writer__7426__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__12816 = o;
(G__12816[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__12825 = jsprops;
(G__12825["defaultValue"] = value);

(G__12825["onChange"] = ((function (G__12825,v,value,on_change){
return (function (p1__12822_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__12822_SHARP_);
});})(G__12825,v,value,on_change))
);

(G__12825["ref"] = ((function (G__12825,v,value,on_change){
return (function (p1__12823_SHARP_){
return (this$["cljsInputElement"] = p1__12823_SHARP_);
});})(G__12825,v,value,on_change))
);
...
var vec__12832 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__12832,(0),null);
var id = cljs.core.nth.call(null,vec__12832,(1),null);
var class$ = cljs.core.nth.call(null,vec__12832,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___12837 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___12837 == null)){
} else {
var key_12838 = temp__4661__auto___12837;
(jsprops["key"] = key_12838);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__12840 = (new reagent.impl.template.NativeWrapper());
(G__12840["name"] = c);
...
var len__7923__auto___12845 = arguments.length;
var i__7924__auto___12846 = (0);
while(true){
if((i__7924__auto___12846 < len__7923__auto___12845)){
args__7930__auto__.push((arguments[i__7924__auto___12846]));

var G__12847 = (i__7924__auto___12846 + (1));
i__7924__auto___12846 = G__12847;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12843){
var G__12844 = cljs.core.first.call(null,seq12843);
var seq12843__$1 = cljs.core.next.call(null,seq12843);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__12844,seq12843__$1);
});
...
break;
default:
var G__12851 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__12851;
continue;
...
var n__7737__auto___12854 = a.length;
var i_12855 = (0);
while(true){
if((i_12855 < n__7737__auto___12854)){
(a[i_12855] = reagent.impl.template.as_element.call(null,(a[i_12855])));

var G__12856 = (i_12855 + (1));
i_12855 = G__12856;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__7737__auto___12857 = a.length;
var i_12858 = (0);
while(true){
if((i_12858 < n__7737__auto___12857)){
var val_12859 = (a[i_12858]);
if((cljs.core.vector_QMARK_.call(null,val_12859)) && ((reagent.impl.template.key_from_vec.call(null,val_12859) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12858] = reagent.impl.template.as_element.call(null,val_12859));

var G__12860 = (i_12858 + (1));
i_12858 = G__12860;
continue;
} else {
}
...
var ctx = ({});
var vec__12864 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__12864,(0),null);
var derefed = cljs.core.nth.call(null,vec__12864,(1),null);
...
var G__12868 = (cljs.core.count.call(null,argv) - first_child);
switch (G__12868) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__12868){
